 function init() {
   ...
   function loadDataFromDB() {
     if (document.getElementById('downloadData').value != "") {
       ...
       instanceOfPresetFromDB = JSON.parse(document.getElementById('downloadInstanceOfPreset').value)
   ...
   myDiagram.addModelChangedListener(function(e) {
     if (e.change === go.ChangedEvent.Transaction) {
       if (e.propertyName === "CommittingTransaction" || e.modelChange === "SourceChanged") {
         ...
         document.getElementById("uploadInstanceOfPreset").value = JSON.stringify(instanceOfPresetList);
         ...
         myDiagram.commit(function(d) {
           d.links.each(function(link) {
             ...
             instanceOfPresetList.forEach((elem) => {
               if (elem.linkFrom == link.data.from && elem.linkTo == link.data.to) {
